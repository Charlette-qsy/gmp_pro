...
// Voltage gain
#define CTRL_VOLTAGE_SENSOR_GAIN (2.2 * 0.983607 / 202.2)

// Voltage Bias, V
#define CTRL_VOLTAGE_SENSOR_BIAS (0.99487)

// Current Gain
#define CTRL_CURRENT_SENSOR_GAIN (0.1012)

// Current Bias, V
#define CTRL_CURRENT_SENSOR_BIAS (0.8847)
